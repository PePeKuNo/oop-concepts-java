...
#### Metoda 1: Kompilacja i uruchomienie z linii poleceń

**Wersja "before" (naruszenie OCP):**
```powershell
...
#### Metoda 2: Uruchomienie z IDE (IntelliJ IDEA)

1. Otwórz projekt w IntelliJ IDEA
2. Znajdź plik `AreaCalculatorDemo.java` (before) lub `ShapeDemo.java` (after)
3. Kliknij prawym przyciskiem na plik
4. Wybierz **Run 'AreaCalculatorDemo.main()'** lub **Run 'ShapeDemo.main()'**

#### Metoda 3: Najszybsza - użyj gotowego skryptu
...
- Kompiluje obie wersje (before i after)
- Uruchamia obie demonstracje
- Pokazuje różnice między naruszeniem a zgodnym podejściem

#### Metoda 4: Test wszystkich zasad SOLID naraz

Uruchom skrypt testowy dla wszystkich zasad SOLID:
```powershell
cd C:\home\gitHub\oop-concepts-java\03_ADVANCED\src
.\test-all-solid-demos.ps1
```

#### Oczekiwane wyniki

**Before (naruszenie OCP):**
```
...
⚠️ Problem:
- Dodanie Triangle wymaga modyfikacji AreaCalculator
- Naruszenie OCP: klasa nie jest zamknięta na modyfikację
...
**Problem - naruszenie OCP:**
- [before/AreaCalculator.java](before/AreaCalculator.java) - Naruszenie OCP, wymaga modyfikacji przy dodawaniu nowych figur
- [before/AreaCalculatorDemo.java](before/AreaCalculatorDemo.java) - Demonstracja problemu

**Rozwiązanie - zastosowanie OCP:**
- [after/Shape.java](after/Shape.java) - Interfejs dla wszystkich figur geometrycznych
- [after/Circle.java](after/Circle.java) - Implementacja koła
- [after/Rectangle.java](after/Rectangle.java) - Implementacja prostokąta
- [after/Triangle.java](after/Triangle.java) - Nowa figura dodana bez modyfikacji istniejącego kodu
- [after/AreaCalculator.java](after/AreaCalculator.java) - Kalkulator zgodny z OCP
- [after/ShapeDemo.java](after/ShapeDemo.java) - Demonstracja działania systemu

### Diagram klas

![Diagram klas - OCP](diagrams/ocp_class_diagram.puml)
