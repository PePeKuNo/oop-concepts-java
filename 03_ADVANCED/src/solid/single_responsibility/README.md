...
**Before (naruszenie SRP):**
- Klasa Employee ma 4 różne odpowiedzialności
- Trudne testowanie - wymaga mockowania bazy danych
- Wszystko w jednej klasie

**After (zgodnie z SRP):**
- Każda klasa ma jedną odpowiedzialność
- Łatwe testowanie każdej klasy osobno
- Pokazuje obliczanie wynagrodzeń, zapis do bazy i generowanie raportów
